  ...
  return (
    <div id="tokenomics" className="text-white py-12 px-4 font-stone relative">
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
        <h2 className="text-3xl font-bold mb-6 text-fuchsia-600">The chase is on, little degen. Dash into the safety of your stablecoins, or better yet, dash away from the screen. But it won't help. The game is just beginning, and $BOOGIE’s shadow looms large. Radium's liberation is my resurrection, and when I rise, the whole Tron blockchain will echo with the sound of your heartbeats... and your screams."

</h2>

          <p className="mb-4">
            $BOOGIE PreSale will take place on sunpump.meme, BEAN WILL MAKE JEETS CRY
          </p>
          <h3 className="text-2xl font-bold mb-4 text-fuchsia-600">Radium's liberation is my resurrection</h3>
